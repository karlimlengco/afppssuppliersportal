            ...
            }else
            {
                $model  = $model->select([
                    DB::raw("
                        ...
                        from upr_view as uv
                        where mode_of_procurement  != 'public_bidding'
                        and upr_view.programs = uv.programs and status != 'draft' and date_processed >= '$date_from' and date_processed <= '$date_to' AND YEAR(date_processed) <= '$yearto'AND YEAR(date_processed) >= '$yearfrom' )
                        as upr_count"),
                ]);
