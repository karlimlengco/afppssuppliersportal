...
use \Revlv\Settings\Forms\Voucher\VoucherRepository;
...
class VoucherFormController extends Controller
{
     ...
     * @var string
     */
    protected $baseUrl  =   "maintenance.forms-vouchers.";
    ...
    {
        return $this->view('modules.settings.forms.vouchers.index');
    }
    ...
    public function create(CateredUnitRepository $units)
    {
        ...
        $filePath = base_path()."/resources/views/forms/default-voucher.blade.php";
        ...
        $this->view('modules.settings.forms.vouchers.create',[
    ...
    public function store(Request $request, VoucherRepository $model)
    {
        $this->validate($request, [
            'unit_id'   =>  'required|unique:voucher_forms,unit_id',
            'content'   =>  'required'
        ]);
    ...
    public function edit($id, VoucherRepository $model)
    {
        ...
        return $this->view('modules.settings.forms.vouchers.edit',[
            'data'          =>  $result,
            'indexRoute'    =>  $this->baseUrl.'index',
            'modelConfig'   =>  [
                'update' =>  [
