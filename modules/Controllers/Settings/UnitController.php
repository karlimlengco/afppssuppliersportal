...
class UnitController extends Controller
{
     ...
     */
    public function getDatatable(UnitRepository $model)
    {
    ...
    {
        return $this->view('modules.settings.units.index',[
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(UnitRequest $request, UnitRepository $model)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UnitRequest $request, $id, UnitRepository $model)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy($id, UnitRepository $model)
    {
        $model->delete($id);
