...
class MFOFormController extends Controller
{
     ...
     */
    public function getDatatable(MFORepository $model)
    {
     ...
     * @var string
     */
    protected $baseUrl  =   "maintenance.forms-mfo.";
    ...
    {
        return $this->view('modules.settings.forms.mfo.index');
    }
    ...
    public function create(CateredUnitRepository $units)
    {
        ...
        $this->view('modules.settings.forms.mfo.create',[
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, MFORepository $model)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit($id, MFORepository $model)
    {
        ...
        return $this->view('modules.settings.forms.mfo.edit',[
            'data'          =>  $result,
            'indexRoute'    =>  $this->baseUrl.'index',
            'modelConfig'   =>  [
                'update' =>  [
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $id, MFORepository $model)
    {
        $this->validate($request,[
            'content'   =>  'required'
        ]);
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy($id, MFORepository $model)
    {
        //
    }
}
