...
class ProcurementController extends Controller
{
     ...
     */
    public function ongoing(UnitPurchaseRequestEloquent $model)
    {
        $suppliers = \Sentinel::getUser()->suppliers;
     ...
     * @return \Illuminate\Http\Response
     */
    public function awarded(UnitPurchaseRequestEloquent $model)
    {
        $suppliers = \Sentinel::getUser()->suppliers;
     ...
     * @return \Illuminate\Http\Response
     */
    public function failed(UnitPurchaseRequestEloquent $model)
    {
        $suppliers = \Sentinel::getUser()->suppliers;
     ...
     * @return \Illuminate\Http\Response
     */
    public function all(UnitPurchaseRequestEloquent $model)
    {
        $suppliers = \Sentinel::getUser()->suppliers;
