...
trait PSRTrait
{
    ...
    public function getPSR($search = null)
    {
        ...
        $model  =   $model->select([
            ...
            DB::raw("COUNT(request_for_quotations.awarded_date) as rfq_close"),
            ...
            DB::raw("COUNT(purchase_orders.pcco_released_date) as po_pcco_released"),
            DB::raw("COUNT(purchase_orders.pcco_received_date) as po_pcco_received"),
