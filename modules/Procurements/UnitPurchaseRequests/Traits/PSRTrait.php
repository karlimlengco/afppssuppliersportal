    ...
    public function getPcooPSRDatatable($request = null, $search = null)
    {
          ...
          if($dateTo != null && $dateFrom != null && $search != null )
          {
              if($request->get('type') != 'bidding'){
                ...
                array_push($selected, DB::raw("(select count(u.id) from unit_purchase_requests as u where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as upr_count"));

                array_push($selected, DB::raw("(select count(ntps.id) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntp"));

                array_push($selected, DB::raw("(select count(vous.id) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as voucher"));

                array_push($selected, DB::raw("(select count(vous.payment_release_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ldad"));


                array_push($selected, DB::raw("(select count(vous.preaudit_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as end_process"));


                array_push($selected, DB::raw("(select count(diirs.id) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir"));

                array_push($selected, DB::raw("(select count(diirs.start_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_start"));
                array_push($selected, DB::raw("(select count(diirs.closed_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_close"));

                array_push($selected, DB::raw("(select count(tiacs.id) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as tiac"));

                array_push($selected, DB::raw("(select count(tiacs.accepted_date) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as coa_inspection"));


                array_push($selected, DB::raw("(select count(ntps.award_accepted_date) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntpa"));


                array_push($selected, DB::raw("(select count(noas.id) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noa"));

                array_push($selected, DB::raw("(select count(pos.id) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po"));

                array_push($selected, DB::raw("(select count(pos.mfo_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_released"));

                array_push($selected, DB::raw("(select count(pos.mfo_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_received"));


                array_push($selected, DB::raw("(select count(pos.funding_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_released"));


                array_push($selected, DB::raw("(select count(pos.funding_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_received"));

                array_push($selected, DB::raw("(select count(pos.coa_approved_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_coa_approved"));

                array_push($selected, DB::raw("(select count(noas.accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noar"));

                array_push($selected, DB::raw("(select count(noas.award_accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noaa"));

                array_push($selected, DB::raw("(select count(isp.id) from ispq_quotations as isp LEFT JOIN unit_purchase_requests as u ON u.id = isp.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ispq"));

                array_push($selected, DB::raw("(select count(rfq.completed_at) from request_for_quotations as rfq LEFT JOIN unit_purchase_requests as u ON u.id = rfq.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND request_for_quotations.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as rfq_close"));


                array_push($selected, DB::raw("(select count(c.id) from canvassing as c LEFT JOIN unit_purchase_requests as u ON u.id = c.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND u.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as canvass"));
                ...
                array_push($selected, DB::raw("(select count(vous.id) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as voucher"));


                array_push($selected, DB::raw("(select count(vous.payment_release_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ldad"));

                array_push($selected, DB::raw("(select count(vous.preaudit_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as end_process"));


                array_push($selected, DB::raw("(select count(diirs.id) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir"));


                array_push($selected, DB::raw("(select count(diirs.start_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_start"));

                array_push($selected, DB::raw("(select count(diirs.closed_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_close"));



                array_push($selected, DB::raw("(select count(tiacs.id) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as tiac"));

                array_push($selected, DB::raw("(select count(tiacs.accepted_date) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as coa_inspection"));

                array_push($selected, DB::raw("(select count(ntps.id) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntp"));


                array_push($selected, DB::raw("(select count(ntps.award_accepted_date) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntpa"));



                array_push($selected, DB::raw("(select count(pos.id) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po"));


                array_push($selected, DB::raw("(select count(pos.mfo_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_released"));


                array_push($selected, DB::raw("(select count(pos.mfo_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_received"));




                array_push($selected, DB::raw("(select count(pos.funding_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_released"));


                array_push($selected, DB::raw("(select count(pos.funding_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_received"));


                array_push($selected, DB::raw("(select count(pos.coa_approved_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement = 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND unit_purchase_requests.upr_number LIKE %$search% AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_coa_approved"));
          ...
          } elseif($dateTo != null && $dateFrom != null)
          {
              if($request->get('type') != 'bidding'){
                ...
                array_push($selected, DB::raw("(select count(u.id) from unit_purchase_requests as u where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as upr_count"));

                array_push($selected, DB::raw("(select count(vous.id) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as voucher"));

                array_push($selected, DB::raw("(select count(vous.payment_release_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ldad"));


                array_push($selected, DB::raw("(select count(vous.preaudit_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as end_process"));

                array_push($selected, DB::raw("(select count(diirs.id) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir"));

                array_push($selected, DB::raw("(select count(diirs.start_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_start"));


                array_push($selected, DB::raw("(select count(diirs.closed_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_close"));

                array_push($selected, DB::raw("(select count(tiacs.id) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as tiac"));

                array_push($selected, DB::raw("(select count(tiacs.accepted_date) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as coa_inspection"));

                array_push($selected, DB::raw("(select count(ntps.id) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntp"));
                array_push($selected, DB::raw("(select count(ntps.award_accepted_date) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntpa"));

                array_push($selected, DB::raw("(select count(pos.id) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po"));

                array_push($selected, DB::raw("(select count(pos.mfo_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_released"));
                array_push($selected, DB::raw("(select count(pos.mfo_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_received"));
                array_push($selected, DB::raw("(select count(pos.funding_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_released"));

                array_push($selected, DB::raw("(select count(pos.funding_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_received"));

                array_push($selected, DB::raw("(select count(pos.coa_approved_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_coa_approved"));


                array_push($selected, DB::raw("(select count(noas.id) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id  AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noa"));


                array_push($selected, DB::raw("(select count(noas.award_accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id  AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noaa"));
                array_push($selected, DB::raw("(select count(noas.accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id  AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noar"));


                array_push($selected, DB::raw("(select count(rfq.completed_at) from request_for_quotations as rfq LEFT JOIN unit_purchase_requests as u ON u.id = rfq.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as rfq_close"));

                array_push($selected, DB::raw("(select count(c.id) from canvassing as c LEFT JOIN unit_purchase_requests as u ON u.id = c.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as canvass"));

                array_push($selected, DB::raw("(select count(isp.id) from ispq_quotations as isp LEFT JOIN unit_purchase_requests as u ON u.id = isp.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ispq"));
          ...
          {
              if($request->get('type') != 'bidding'){
                array_push($selected, DB::raw("(select count(u.id) from unit_purchase_requests as u where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as upr_count"));

                array_push($selected, DB::raw("(select count(vous.id) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as voucher"));


                array_push($selected, DB::raw("(select count(vous.payment_release_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ldad"));


                array_push($selected, DB::raw("(select count(vous.preaudit_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as end_process"));

                array_push($selected, DB::raw("(select count(diirs.id) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir"));


                array_push($selected, DB::raw("(select count(diirs.start_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_start"));

                array_push($selected, DB::raw("(select count(diirs.closed_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_close"));

                array_push($selected, DB::raw("(select count(tiacs.id) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as tiac"));


                array_push($selected, DB::raw("(select count(tiacs.accepted_date) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as coa_inspection"));

                array_push($selected, DB::raw("(select count(ntps.id) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntp"));

                array_push($selected, DB::raw("(select count(ntps.award_accepted_date) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntpa"));


                array_push($selected, DB::raw("(select count(pos.id) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po"));


                array_push($selected, DB::raw("(select count(pos.mfo_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_released"));


                array_push($selected, DB::raw("(select count(pos.mfo_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_received"));


                array_push($selected, DB::raw("(select count(pos.funding_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_released"));


                array_push($selected, DB::raw("(select count(pos.funding_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_received"));

                array_push($selected, DB::raw("(select count(pos.coa_approved_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_coa_approved"));

                array_push($selected, DB::raw("(select count(noas.id) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noa"));


                array_push($selected, DB::raw("(select count(noas.award_accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noaa"));

                array_push($selected, DB::raw("(select count(noas.accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noar"));

                array_push($selected, DB::raw("(select count(rfq.completed_at) from request_for_quotations as rfq LEFT JOIN unit_purchase_requests as u ON u.id = rfq.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as rfq_close"));

                array_push($selected, DB::raw("(select count(c.id) from canvassing as c LEFT JOIN unit_purchase_requests as u ON u.id = c.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as canvass"));

                array_push($selected, DB::raw("(select count(isp.id) from ispq_quotations as isp LEFT JOIN unit_purchase_requests as u ON u.id = isp.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed <= $dateTo AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ispq"));
          ...
          } elseif($dateTo == null && $dateFrom != null)
          {
              if($request->get('type') != 'bidding'){
                ...
                array_push($selected, DB::raw("(select count(u.id) from unit_purchase_requests as u where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as upr_count"));

                array_push($selected, DB::raw("(select count(vous.id) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as voucher"));
                array_push($selected, DB::raw("(select count(vous.payment_release_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ldad"));

                array_push($selected, DB::raw("(select count(vous.preaudit_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as end_process"));

                array_push($selected, DB::raw("(select count(diirs.id) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir"));

                array_push($selected, DB::raw("(select count(diirs.start_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_start"));

                array_push($selected, DB::raw("(select count(diirs.closed_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_close"));


                array_push($selected, DB::raw("(select count(tiacs.id) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as tiac"));

                array_push($selected, DB::raw("(select count(tiacs.accepted_date) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as coa_inspection"));

                array_push($selected, DB::raw("(select count(ntps.id) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntp"));

                array_push($selected, DB::raw("(select count(ntps.award_accepted_date) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ntpa"));

                array_push($selected, DB::raw("(select count(pos.id) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po"));

                array_push($selected, DB::raw("(select count(pos.mfo_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_released"));
                array_push($selected, DB::raw("(select count(pos.mfo_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_mfo_received"));

                array_push($selected, DB::raw("(select count(pos.funding_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_released"));

                array_push($selected, DB::raw("(select count(pos.funding_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_pcco_received"));
                array_push($selected, DB::raw("(select count(pos.coa_approved_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as po_coa_approved"));

                array_push($selected, DB::raw("(select count(noas.id) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noa"));

                array_push($selected, DB::raw("(select count(noas.award_accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noaa"));

                array_push($selected, DB::raw("(select count(noas.accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noar"));

                array_push($selected, DB::raw("(select count(rfq.completed_at) from request_for_quotations as rfq LEFT JOIN unit_purchase_requests as u ON u.id = rfq.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as rfq_close"));

                array_push($selected, DB::raw("(select count(c.id) from canvassing as c LEFT JOIN unit_purchase_requests as u ON u.id = c.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as canvass"));

                array_push($selected, DB::raw("(select count(isp.id) from ispq_quotations as isp LEFT JOIN unit_purchase_requests as u ON u.id = isp.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement != 'public_bidding' AND u.date_processed >= $dateFrom AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ispq"));
              ...
              if($request->get('type') != 'bidding'){
                ...
                array_push($selected, DB::raw("(select count(u.id) from unit_purchase_requests as u where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as upr_count"));

                array_push($selected, DB::raw("(select count(vous.id) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as voucher"));

                array_push($selected, DB::raw("(select count(vous.payment_release_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as ldad"));

                array_push($selected, DB::raw("(select count(vous.preaudit_date) from vouchers as vous LEFT JOIN unit_purchase_requests as u ON u.id = vous.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as end_process"));


                array_push($selected, DB::raw("(select count(diirs.id) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir"));
                array_push($selected, DB::raw("(select count(diirs.start_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_start"));
                array_push($selected, DB::raw("(select count(diirs.closed_date) from delivery_inspection as diirs LEFT JOIN unit_purchase_requests as u ON u.id = diirs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as diir_close"));


                  array_push($selected, DB::raw("(select count(tiacs.id) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as tiac"));

                  array_push($selected, DB::raw("(select count(tiacs.accepted_date) from inspection_acceptance_report as tiacs LEFT JOIN unit_purchase_requests as u ON u.id = tiacs.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as coa_inspection"));

                array_push($selected, DB::raw("(select count(ntps.id) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as ntp"));

                array_push($selected, DB::raw("(select count(ntps.award_accepted_date) from notice_to_proceed as ntps LEFT JOIN unit_purchase_requests as u ON u.id = ntps.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as ntpa"));

                  array_push($selected, DB::raw("(select count(pos.id) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as po"));
                  array_push($selected, DB::raw("(select count(pos.mfo_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as po_mfo_released"));

                  array_push($selected, DB::raw("(select count(pos.mfo_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as po_mfo_received"));

                  array_push($selected, DB::raw("(select count(pos.funding_released_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as po_pcco_released"));


                  array_push($selected, DB::raw("(select count(pos.funding_received_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as po_pcco_received"));


                  array_push($selected, DB::raw("(select count(pos.coa_approved_date) from purchase_orders as pos LEFT JOIN unit_purchase_requests as u ON u.id = pos.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom' ) as po_coa_approved"));



                array_push($selected, DB::raw("(select count(noas.id) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noa"));
                array_push($selected, DB::raw("(select count(noas.award_accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noaa"));
                array_push($selected, DB::raw("(select count(noas.accepted_date) from notice_of_awards as noas LEFT JOIN unit_purchase_requests as u ON u.id = noas.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as noar"));

                array_push($selected, DB::raw("(select count(rfq.completed_at) from request_for_quotations as rfq LEFT JOIN unit_purchase_requests as u ON u.id = rfq.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom'  ) as rfq_close"));


                array_push($selected, DB::raw("(select count(c.id) from canvassing as c LEFT JOIN unit_purchase_requests as u ON u.id = c.upr_id where u.procurement_office = procurement_centers.id  AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as canvass"));
                array_push($selected, DB::raw("(select count(isp.id) from ispq_quotations as isp LEFT JOIN unit_purchase_requests as u ON u.id = isp.upr_id where u.procurement_office = procurement_centers.id AND mode_of_procurement  != 'public_bidding' AND YEAR(u.date_processed) <= '$yearto' AND YEAR(u.date_processed) >= '$yearfrom') as ispq"));
