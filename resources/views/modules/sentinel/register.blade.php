...
<div class="login">
    <div class="heading">
        ...
        <div class="branding">
            ...
            Hooray ! Welcome to DOCU PARSER<br>Just a few more steps to register your account.
            <a href="{{ route('register.activate', [ $data['email'], $data['code'], $data['plan'] ]) }}">click here</a>
            </div>
        </div>
    </div>
</div>
