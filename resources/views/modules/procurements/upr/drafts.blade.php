...
<div class="row">
    <br>
    <h3><span style="border-bottom:2px solid black">List of Draft Unit Purchase Requests(UPRs)</span></h3>
    <div class="twelve columns">
...
<script type="text/javascript">
    ...
    table = $('#datatable-responsive').DataTable({
        ...
        serverSide: true,
        ajax: {
                url: "{{route('datatables.procurements.unit-purchase-request.drafts')}}",
                // data: function (d) {
