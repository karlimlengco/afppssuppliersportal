...
<table class="table table--with-border ">
    ...
    <thead>
        <tr>
           ...
           <th   style="background: #222222"  class="align-center" width="5%">Approved Bid Price  <br><strong>({{formatPrice($totalBid)}})</strong></th>
           <th   style="background: #222222"  class="align-center" width="10%">Current Status</th>
        </tr>
    </thead>
    <tbody>
        <?php $totalAbc = 0; ?>
