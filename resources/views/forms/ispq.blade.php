        ...
        <div class="printable-form-wrapper" style="padding-top:50px">
            ...
            <div class="printable-form">
                ...
                <div class="printable-form__body">
                    ...
                    <p>1. The Armed Forces of the Philippines through the {{($center) ? $center->short_code : ""}} Canvass/Contracting Committee invites PhilGEPS registered suppliers to submit quotation/proposal for the following list of procurement with corresponding Approved Budget for the Contract (ABC).</p>
                    <table class="printable-form__body__table">
                        ...
                        @foreach($data['quotations'] as $key => $quotation)
                            <tr>
                                ...
                                <td class="align-center" >{{ str_replace('AMP', 'RFQ', $quotation->upr->ref_number) }}</td>
                    ...
                    <p>2. Interested Suppliers may obtain further information from Canvass Contracting Committee Secretariat at the office of {{($center) ? $center->name : ""}}, {{ ($center) ?$center->address : ""}} for the issuance of Request for Quotation (RFQ) from <strong>8:00 AM - 5:00 PM Monday to Friday excluding Saturdays, Sundays and Holidays</strong>.</p>
                        ...
                        <tr>
                            ...
                            <td width="45%">
                              ...
                              <table class="signatory">
                                  <tr>
                                      <td>
                                          <div class="signatory-name-justify">
                                              <strong>{{$data['signatories'][0]}}</strong>
                                              <span></span>
                                          </div>
                                      </td>
                                      <td></td>
                                  ...
                                  <tr>
                                      <td>
                                          <div class="signatory-rank-justify">
                                              <strong>{{$data['signatories'][1]}} {{$data['signatories'][2]}}</strong>
                                              <span></span>
                                          </div>
                                      </td>
                                      <td></td>
                                  ...
                                  <tr>
                                      <td nowrap>{{$data['signatories'][3]}}</td>
                                      <td></td>
                                  </tr>
                              </table>
                            </td>
