            ...
            <div class="printable-form">
                ...
                <div class="printable-form__body no-letterhead boxed boxed__no-padding">
                    ...
                    <table class="printable-form__body__table classic">
                        ...
                        <tr>
                            <td class="no-border-top no-border-bottom" style="text-indent: justify" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To payment for the ten (10) Line Items(s) spicified and delivered under Purchase Order Number GHQPC-OCSAFP-SPOF-001-17 in the amount of <strong>THIRTY THREE THOUSAND EIGHT HUNDRED SEVENTY FIVE PESOS ONLY (Php 33,875.00)</strong></td>
                            <td class="no-border-top no-border-bottom"></td>
                            <td class="no-border-top no-border-bottom"></td>
                            <td class="no-border-top no-border-bottom align-right"><strong>Php {{ formatPrice($data['amount'])}}</strong></td>
                        </tr>
                        <tr>
