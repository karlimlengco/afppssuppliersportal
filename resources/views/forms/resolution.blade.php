        ...
        <div class="printable-form-wrapper" style="padding-top:50px">
            <div class="printable-form">
                ...
                <div class="printable-form__body">
                    ...
                    <span class="printable-form__body__subtitle">Opening of Canvass Proposal for the procurement of PMC Requirements</span>
                    ...
                    <p>
                        ...
                        @endforeach
                        <strong>Other Attendees:</strong><br>
                    </p>
                    ...
                    <p>{{$canvass->canvass->resolution}}</p>
                    @endforeach
                </div>
                <!-- form footer -->
            ...
            <div class="printable-form">
                ...
                <div class="printable-form__body no-letterhead">
                    <p>f. Declaring CZARMAG TRADING as the winner for having garnered the lowest price offered among others for the Supply & Delivery of Training Supplies under request for quotation number PNPC-PMC-TRNG-056-17;</p>
                    <p>g. Declaring GCNV TRADING as the winner for having garnered the lowest price offered among others for the Supply & Delivery of IT-Equipment Parts & Accessories under request for quotation number PNPC-PMC-RMIC-057-17;</p>
                    <p>h. Declaring RVCA TRADING & GENERAL MERCHANDISE TRADING as the winner for having garnered the lowest price offered among others for the Supply & Delivery of Grocery items under request for quotation number PNPC-PMC-REPE-058-17;</p>
                    <p>i. RESOLVED, at the Office of the PNPC, Naval Station Jose Francisco, Fort Bonifacio, Taguig City, this 22nd day of June 2017;</p><br><br>
                    <p class="align-center"><strong>PHILIPPINE NAVY PROCUREMENT CENTER<br>CANVASS/CONTRACTING COMMITTEE</strong></p>
                    <!-- form signatories -->
                    <table class="printable-form__body__table
