                ...
                <div class="printable-form">
                    ...
                    <div class="printable-form__body">
                        ...
                        <table class="printable-form__body__table no-border no-padding">
                            <tr>
                                <td class="align-left" width="50%">{{\Carbon\Carbon::createFromFormat('Y-m-d',$data['transaction_date'])->format('d F Y')}}</td>
                        ...
                        <table class="printable-form__body__table no-border no-padding">
                            <tr>
                                ...
                                <td class="align-bottom align-left" width="45%" height="60px">
                                    <strong> @if(count($data['chief']) > 1)  {{$data['chief'][1]}} {{$data['chief'][0]}} {{$data['chief'][2]}} </strong><br>
                                    {{$data['chief'][3]}}
                                    @endif
                                </td>
                            </tr>
                        ...
                        <ol>
                            ...
                            {!!$data['content']!!}
                            <li>APPROVED BUDGET FOR THE CONTRACT IS: <strong><strong style="text-transform:uppercase">{{translateToWords($data['total_amount'])}}. ( Php{{formatPrice($data['total_amount'])}})</strong></strong></li>
                        </ol>
