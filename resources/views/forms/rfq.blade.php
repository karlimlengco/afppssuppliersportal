                ...
                <div class="printable-form">
                    ...
                    <div class="printable-form__body">
                        ...
                        <ol>
                            ...
                            {!! $data['content'] !!}
                            <li>APPROVED BUDGET FOR THE CONTRACT IS: <strong><strong style="text-transform:uppercase">{{translateToWords(str_replace(',', '', $data['total_amount']))}}. ( Php{{formatPrice($data['total_amount'])}})</strong></strong></li>
                        </ol>
