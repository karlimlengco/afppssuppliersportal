        ...
        <div class="printable-form-wrapper">
            ...
            <div class="printable-form">
                ...
                <div class="printable-form__body">
                    ...
                    <p style="text-align: justify;font-size:18px!important;">We are pleased to notify you that your price offer/s for the procurement of {{translateToWordsPoints($data['items'][0]->quantity)}} ({{$data['items'][0]->quantity}}) {{$data['items'][0]->item_description}} @if(count($data['items']) > 1) and {{translateToWordsPoints(count($data['items']) - 1)}} {{count($data['items']) - 1}} LI @endif only for the use of RFQ No.{{$data['rfq_number']}} dated {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$data['rfq_date'])->format('d F Y')}} for the use of {{$data['unit']}} in the amount of {{translateToWords( str_replace(',', '', $data['bid_amount']) )}} (Php {{formatPrice($data['bid_amount'])}}) is hereby accepted. A contract for the procurement of this item/s is being awarded to your company/firm.</p>
                    <p  style="text-align: justify;font-size:18px!important;">You shall subsequently be informed (thru your contact number or email address specified below) accordingly to appear before this office for the requirements.</p>
                    ...
                    <p style="font-size:18px!important;">Very truly yours;</p>
                    ...
                    <table class="printable-form__body__table no-border no-padding" style="font-size:18px!important;">
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td style="font-size:18px!important;"><strong>Conforme:</strong></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
